defmodule GameClient do
  ...
  def ask_stones() do
    ...
    String.trim|>
    Integer.parse |> #returns {integer, extra_stuff} or :error
    stones_to_take()
  end
  defp take() do
...
defmodule GameServer do
  ...
  defp listen({nil, 0}), do: listen({1,30}) #when the game ends, start again!
  ...
  num_stones_to_take > current_stones_count do
    ...
    cannot exceed the total count of stones in pile!"}
